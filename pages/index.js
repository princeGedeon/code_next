    ...
    <div className="container mx-auto px-10 pt-5">
      ...
      <div className="mt-10 mx-auto flex flex-col  gap-4  md:flex-row">
        <div className="w-full min-h-fit max-h-full border border-gray-500 px-5 py-5  rounded-md">
          ...
          <Link href="/blog" >
          <a className="text-blue-800 text-white text-md rounded-md bg-sky-700 mt-2 px-2 py-3 hover:bg-gray-600 hover:text-slate-100 ">Visitez le blog</a>
          </Link>
        ...
        <div className="w-full min-h-fit max-h-full border border-gray-500 px-5 py-5  rounded-md">
          ...
          <a className="text-white text-md  rounded-md bg-sky-600 mt-2 px-2 py-3 hover:bg-gray-600 hover:text-white ">Découvrez nos membres</a>
          </Link>
